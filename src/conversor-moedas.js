...
function ConversorMoedas() {
  const FIXER_URL =
    "http://data.fixer.io/api/latest?access_key=919e4d3ed1ff9e4f93ff76417716d0b1";
  ...
  function handleButtonFecharModal(event) {
    setExibirModal(false);
  }
    ...
    <div>
      ...
      <Jumbotron>
        ...
        <Modal show={exibirModal} data-testid='modal'>
          <Modal.Header closeButton onClick={handleButtonFecharModal}>
